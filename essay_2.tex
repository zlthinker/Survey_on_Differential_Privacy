...
\section*{Conclusion}
We have surveyed a number of approached in the context of different privacy triggered by rising needs of data publishment and privacy protection. Targeted at various requirements and situations, a large literature has explored abundant differentially private mechanisms \cite{mcsherry2007mechanism}, three of which has been introduced in this writing. A number of sub-fields of differential privacy like local differential privacy have also been investigated to apply it into more specific applications. Although we may not notice, differential privacy is supporting the world full of information and knowledge in its way.
